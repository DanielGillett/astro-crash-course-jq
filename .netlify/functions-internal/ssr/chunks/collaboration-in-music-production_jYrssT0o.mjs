const id = "collaboration-in-music-production.md";
						...
						const data = {author:"michael-scott",date:"08/10/2021",image:
					...
					,title:"Collaboration in music production"};
						const _internal = {
							type: 'content',
							filePath: "/root/daniel/code/astro/tutorials/freeCodeCamp/fcc-astro-crash-course/src/content/posts/collaboration-in-music-production.md",
