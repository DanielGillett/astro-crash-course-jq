const id = "guitar-solos-are-still-awesome.md";
						...
						const data = {author:"jim-halpert",date:"08/10/2021",image:
					...
					,title:"Guitar solos are still awesome"};
						const _internal = {
							type: 'content',
							filePath: "/root/daniel/code/astro/tutorials/freeCodeCamp/fcc-astro-crash-course/src/content/posts/guitar-solos-are-still-awesome.md",
