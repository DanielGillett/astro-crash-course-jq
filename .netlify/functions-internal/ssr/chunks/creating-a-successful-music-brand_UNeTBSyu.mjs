const id = "creating-a-successful-music-brand.md";
						...
						const data = {author:"pam-beesely",date:"08/10/2021",image:
					...
					,title:"Creating a successful music brand"};
						const _internal = {
							type: 'content',
							filePath: "/root/daniel/code/astro/tutorials/freeCodeCamp/fcc-astro-crash-course/src/content/posts/creating-a-successful-music-brand.md",
