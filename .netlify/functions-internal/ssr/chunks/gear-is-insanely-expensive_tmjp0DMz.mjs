const id = "gear-is-insanely-expensive.md";
						...
						const data = {author:"dwight-schrute",date:"08/10/2021",image:
						new Proxy({"src":"/_astro/gear.hUEiuUwP.jpg","width":5184,"height":3456,"format":"jpg"}, {
					...
					,title:"Gear is insanely expensive"};
						const _internal = {
							type: 'content',
							filePath: "/root/daniel/code/astro/tutorials/freeCodeCamp/fcc-astro-crash-course/src/content/posts/gear-is-insanely-expensive.md",
